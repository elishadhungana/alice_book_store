...
<head>
  ...
  <body>
    ...
    <header id="header">
      ...
      <nav class="navbar navbar-expand-md navbar-light "  style="background-color: #E3242B; ">
        <a href="../../AliceBooks/index.php" class="navbar-brand">
            <h3 class="px-5">
              <!-- <img src="../images/alicelogo.png" alt="Girl in a jacket"> -->
                <i>Alice Book Store</i>
            </h3>
        </a>
	<div class="container-fluid padding">
        ...
        <li class="nav-item">
            <a class="nav-link" href="../../AliceBooks/products.php">Product & Services</a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="../../AliceBooks/privacy-policy.php">Privacy/Policy</a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="../../AliceBooks/contact.php">Find Us</a>
        </li>
