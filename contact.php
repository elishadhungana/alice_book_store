...
<?php
        ...
        while( $row = $query->fetch_assoc() ){
            ...
            $locations[]=array( 'name'=>$name, 'address'=>$address, 'lat'=>$latitude, 'lng'=>$longitude, 'lnk'=>$link );
        }
    ...
    ?>
    <script type="text/javascript" src="http://maps.googleapis.com/maps/api/js?key=AIzaSyBgcLuS3cfaKHjKFkDwMOupe1mZ4N3yD1g"></script>
